                        ...
                        <div className='flex sm:flex-col overflow-x-auto sm:overflow-y-scroll justify-normal sm:justify-normal'>
                            {
                                productData.image.map((item,index) => (
                                    <img onClick={()=>setImage(item)} key={index} src={item} alt={item.title} className='w-[24%] sm:w-full sm:mb-3 flex-shrink-0 cursor-pointer'/>
                                ))
                            }
                        </div>
